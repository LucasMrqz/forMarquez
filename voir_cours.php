    ...
    $query_uti->execute(array($Email));
        ...
        echo "<nav class='navbar'>";
            while($rowan = $query_uti->fetch()){
                echo "<p style='margin-top: 1em; color: white; margin-right: 1em;'> Votre profil : " . $rowan['nomEleve'] . " " . $rowan['prenomEleve'] . " </p>";
        ...
        echo "<tr><td>Id du cours</td><td>Nom du type de cours</td><td>Nom du cours</td><td>Date/Heures du cours</td><td>Duree du cours</td><td>Numéro de la salle</td>\n " ;
            while($rowan = $query_cours->fetch()){
                ...
                echo "</table>";
                echo "<a href='./accueil_eleve.php' class='button-56' style='color: white; margin-top: 2em;text-decoration: none;'>Retour à la page d'accueil</a>";
                echo "<a href='./paiement.php' class='button-56' style='color: white; margin-top: 2em;text-decoration: none;'>Adhérer à la formation</a>";
                echo "<footer>"
                            ."<h2>© 2024</h2>
                        </footer>";
            }
