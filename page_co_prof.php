...
<html lang="fr">
    ...
    <body class ='body-test'>
        <section class="about">
            <div class="container">
                <h1>Page de connexion professeur</h1>
                <form class="contact-form" action="./action_co_prof.php" method="POST"> <!-- Dans ce formulaire, on demande à l'utilisateur son login et son mot de passe--->
